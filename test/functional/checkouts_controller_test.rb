...
class CheckoutsControllerTest < ActionController::TestCase
  ...
  test "should create checkout" do
    assert_difference('Checkout.count') do
      post :create, checkout: { enddate: @checkout.enddate, item_id: @checkout.item_id, startdate: @checkout.startdate, student_id: @checkout.student_id }
    end
  ...
  test "should update checkout" do
    put :update, id: @checkout, checkout: { enddate: @checkout.enddate, item_id: @checkout.item_id, startdate: @checkout.startdate, student_id: @checkout.student_id }
    assert_redirected_to checkout_path(assigns(:checkout))
  end
